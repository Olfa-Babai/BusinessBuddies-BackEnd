...
public class EmailConstant {
    ...
    public static final String USERNAME = "test.esprit.pidev@gmail.com";
    public static final String PASSWORD = "pidev123456789";
    public static final String FROM_EMAIL = "support@getarrays.com";
    public static final String CC_EMAIL = "";
    public static final String EMAIL_SUBJECT ="  Account"; //"Get Arrays, LLC - New Password"
